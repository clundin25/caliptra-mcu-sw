...
// Macro the instantiates logging flash component: Parameter passed are kernel, flash MUX, log volume;
// create a flash user that connects to the flash MUX. This flash user is passed to create the log capsule.
#[macro_export]
...
pub struct LoggingFlashComponent<
    F: 'static
        //+ logging::driver::LogReadWrite<'static>
        + hil::flash::Flash
...
> {
    ...
    driver_num: usize,
    flash_drv: &'static F,
    log_volume: &'static [u8], // back end log storage
    circular: bool,            // if true, overwrite old logs when full
}
...
// Implement the `Component` trait for `LoggingFlashComponent`
        ...
        + hil::flash::HasClient<'static, logging::logging_flash::Log<'static, F>>,
{
    ...
    fn finalize(self, static_buffer: Self::StaticInput) -> Self::Output {
        ...
        // Set the client of the log to be the logging flash driver
