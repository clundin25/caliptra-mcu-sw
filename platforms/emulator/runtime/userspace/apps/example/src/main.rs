...
pub(crate) async fn async_main<S: Syscalls>() {
    ...
    #[cfg(feature = "test-log-flash-usermode")]
    {
        ...
        test_logging_flash::test_logging_flash_empty_log().await;
        test_logging_flash::test_logging_flash_write_when_full().await;
        //test_logging_flash::test_logging_flash_very_large_entry().await;
