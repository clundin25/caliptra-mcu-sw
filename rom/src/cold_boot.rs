...
use crate::{
    ...
    verify_mcu_mbox_axi_users, verify_prod_debug_unlock_pk_hash, BootFlow, DotBlob, HekState,
...
use caliptra_api::mailbox::{
    ...
    MailboxReqHeader, MailboxRespHeader, OcpLockReportHekMetadataReq, OcpLockReportHekMetadataResp,
...
impl BootFlow for ColdBoot {
    fn run(env: &mut RomEnv, params: RomParameters) -> ! {
        ...
        let fuse_state = soc.populate_fuses(otp, mci);
