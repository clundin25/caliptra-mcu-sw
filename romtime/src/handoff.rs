...
#[repr(C, align(4))]
#[derive(Debug, TryFromBytes, IntoBytes, KnownLayout, Immutable, Clone, Copy, Default)]
...
impl HandoffData {
    ...
    /// Create a new handoff data structure with the given HEK state for ROM.
    #[cfg(feature = "ocp-lock")]
    pub fn new(hek_state: HekState) -> Self {
        Self {
            rom: RomHandoffTable {
