...
use super::pldm_client::{DOWNLOAD_CTX, IMAGE_LOADING_TASK_YIELD, PLDM_STATE, PLDM_TASK_YIELD};
use super::pldm_consts::STREAMING_BOOT_FIRMWARE_PARAMS;
...
impl FdOps for StreamingFdOps {
    ...
    async fn get_firmware_parms(
        ...
        let fw_params = STREAMING_BOOT_FIRMWARE_PARAMS.get();
