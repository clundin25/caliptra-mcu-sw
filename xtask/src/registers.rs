...
pub(crate) fn autogen(check: bool) -> Result<(), DynError> {
    ...
    let rdl_files: Vec<PathBuf> = [
        ...
        "hw/caliptra-rtl/src/csrng/data/csrng.rdl",
        "hw/caliptra-rtl/src/keyvault/rtl/kv_def.rdl",
        "hw/caliptra-rtl/src/entropy_src/data/entropy_src.rdl",
        "hw/caliptra-rtl/src/hmac/rtl/hmac_reg.rdl",
        "hw/caliptra-rtl/src/sha256/rtl/sha256_reg.rdl",
        "hw/caliptra-rtl/src/sha512/rtl/sha512_reg.rdl",
        "hw/caliptra-rtl/src/soc_ifc/rtl/mbox_csr.rdl",
        "hw/caliptra-rtl/src/soc_ifc/rtl/sha512_acc_csr.rdl",
        "hw/caliptra-rtl/src/soc_ifc/rtl/soc_ifc_reg.rdl",
        "hw/caliptra-rtl/src/spi_host/data/spi_host.rdl",
        "hw/caliptra-rtl/src/uart/data/uart.rdl",
